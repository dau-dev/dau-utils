...
lint:  ## run python linter with ruff
	...
	python -m ruff format --check dau_utils

# Alias
lints: lint

fix:  ## fix python formatting with ruff
	python -m ruff check --fix dau_utils
	python -m ruff format dau_utils
...
test:  ## run python tests
	python -m pytest -v dau_utils/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v dau_utils/tests --cov=dau_utils --cov-report term-missing --cov-report xml
